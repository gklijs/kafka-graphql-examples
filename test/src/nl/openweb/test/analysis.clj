...
(defn vega-item [category [generator-count data-rows]]
  {
   ...
   :average-db-ch-mem         (get-statistic data-rows 6 kixi/mean)
   :err-db-ch-mem             (get-statistic data-rows 6 kixi/standard-error)
   :average-db-ge-cpu         (get-statistic data-rows 7 kixi/mean)
   :err-db-ge-cpu             (get-statistic data-rows 7 kixi/standard-error)
   :average-db-ge-mem         (get-statistic data-rows 8 kixi/mean)
   :err-db-ge-mem             (get-statistic data-rows 8 kixi/standard-error)
